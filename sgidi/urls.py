...
urlpatterns = [
    ...
    url(r'^ideias/avaliacao/ajax/change_estado/$', views.post_atualizar_estado, name='post_atualizar_estado'),
    url(r'^ideias/avaliacao/postPreAnalise$', IdeiasAvaliacaoView.as_view(), name='ideias_avalicao_post_pre_analise'),
]
